...
jdefn = JobDefn()
jdefn.setEntryPoint("sbatch ~/mxn/mpiBatch.sh")
remoteJobId = runDriver.submitJob(jdefn)

print("Running Local")
localRunDriver = localDriver.getRunDriver()
jdefn = JobDefn()
jdefn.setEntryPoint("~/mxn/mpiHello.sh")
localJobId = localRunDriver.submitJob(jdefn)

print("Setting triggers")
remoteJobSuccess = JobDefn()
jdefn.setEntryPoint("~/mxn/echo.sh 'remote job succeeded'")
localJobSuccess = JobDefn()
jdefn.setEntryPoint("~/mxn/echo.sh 'local job succeeded'")
remoteJobFailed = JobDefn()
jdefn.setEntryPoint("~/mxn/echo.sh 'remote job failed'")
localJobFailed = JobDefn()
jdefn.setEntryPoint("~/mxn/echo.sh 'local job failed'")
